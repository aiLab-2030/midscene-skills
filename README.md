...
All commands run through `npx @midscene/cli@1.3.11-beta-20260211031343.0 <platform> <command>`, which auto-downloads on first use — no pre-installation needed.

```bash
# Web
npx @midscene/cli@1.3.11-beta-20260211031343.0 web navigate "https://example.com" --bridge
npx @midscene/cli@1.3.11-beta-20260211031343.0 web query "what is the page title?" --bridge
