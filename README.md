...
All commands run through `npx @midscene/cli@1.3.12-beta-20260211123127.0 <platform> <command>`, which auto-downloads on first use — no pre-installation needed.

```bash
# Web
npx @midscene/cli@1.3.12-beta-20260211123127.0 web navigate "https://example.com" --bridge
npx @midscene/cli@1.3.12-beta-20260211123127.0 web query "what is the page title?" --bridge

# Computer
npx @midscene/cli@1.3.12-beta-20260211123127.0 computer act "press Command+Space to open Spotlight"
npx @midscene/cli@1.3.12-beta-20260211123127.0 computer screenshot

# Android
npx @midscene/cli@1.3.12-beta-20260211123127.0 android act "tap the Settings icon"
npx @midscene/cli@1.3.12-beta-20260211123127.0 android query "what is the battery percentage?"

# iOS
npx @midscene/cli@1.3.12-beta-20260211123127.0 ios act "tap the Safari icon"
npx @midscene/cli@1.3.12-beta-20260211123127.0 ios assert "Safari is open"
```
