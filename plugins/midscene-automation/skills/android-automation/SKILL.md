...
Automate Android devices using `npx @midscene/android@1.3.12-beta-20260211155735.0`. Each CLI command maps directly to an MCP tool — you (the AI agent) act as the brain, deciding which actions to take based on screenshots.
...
```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 --help
```
...
```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 connect
npx @midscene/android@1.3.12-beta-20260211155735.0 connect --deviceId emulator-5554
```

### Take Screenshot

```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 take_screenshot
```
...
```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 Tap --locate '{"prompt":"the Settings icon"}'
npx @midscene/android@1.3.12-beta-20260211155735.0 Input --locate '{"prompt":"search field"}' --content 'hello world'
npx @midscene/android@1.3.12-beta-20260211155735.0 Scroll --direction down
npx @midscene/android@1.3.12-beta-20260211155735.0 Swipe --locate '{"prompt":"the notification panel"}' --direction down
npx @midscene/android@1.3.12-beta-20260211155735.0 KeyboardPress --value Enter
npx @midscene/android@1.3.12-beta-20260211155735.0 LongPress --locate '{"prompt":"the message bubble"}'
npx @midscene/android@1.3.12-beta-20260211155735.0 Launch --uri 'com.android.settings'
```
...
```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 act --prompt "long press the message, then tap Delete in the popup menu"
```

### Disconnect

```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 disconnect
```
...
```bash
npx @midscene/android@1.3.12-beta-20260211155735.0 act --prompt "long press the message bubble, then tap Delete in the popup menu"
npx @midscene/android@1.3.12-beta-20260211155735.0 take_screenshot
```
...
npx @midscene/android@1.3.12-beta-20260211155735.0 LongPress --locate '{"prompt":"the message bubble"}'
npx @midscene/android@1.3.12-beta-20260211155735.0 Tap --locate '{"prompt":"Delete option in the popup menu"}'
